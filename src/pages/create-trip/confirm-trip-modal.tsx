        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
            <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-zinc-400">Para concluir a criação da viagem para <span className="text-zin100 font-semibold">Florianópolis, Brasil</span> nas datas de <span className="text-zin100 font-semibold">16 a 27 de Agosto de 2024</span> preencha seus dados abaixo:</p>
                </div>
